...
public class JobApplicationController extends ControllerBase implements IGuiController<JobApplication>, Serializable {
    ...
    public void update() {
        try {
            ...
            if (this.newDataItem) {
                ...
                String url = "jobapplication.xsp?openxpage&id=" + jobApplication.getId();
