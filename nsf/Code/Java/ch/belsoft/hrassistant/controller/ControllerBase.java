...
public abstract class ControllerBase implements Serializable {
    ...
    public void loadAttachmnents(IDataItem dataItem){
        setAttachmentHolder(attachmentController.findAttachment(dataItem.getAttachmentId()));
    }
    ...
    public void creatAttachment(IDataItem dataItem){
        attachmentHolder = attachmentController.createNewAttachmentHolderFromUpload(upload, null);
    ...
    public void updateAttachments(IDataItem dataItem){
        try{
            if ((this.newDataItem || "".equals(dataItem.getAttachmentId())) && upload.getUploadFile()!= null) {
                creatAttachment(dataItem);
            }else{
                if(!"".equals(dataItem.getAttachmentId()) && upload.getUploadFile()!=null){
                    //update
                    Attachment attachment = attachmentController.createAttachmentFromUpload(upload);
    ...
    public boolean hasAttachments(){
        return attachmentHolder != null && !attachmentHolder.getAttachments().isEmpty();
    }
