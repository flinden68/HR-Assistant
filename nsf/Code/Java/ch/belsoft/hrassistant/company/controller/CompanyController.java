...
public class CompanyController extends ControllerBase implements
		IGuiController<Company>, Serializable {
	...
	private static final String PAGETITLE_LIST_ALL = "Companies";
	...
	public void update() {
		try {
			...
			if (this.newDataItem) {
				...
				XPagesUtil.redirect("hr_company.xsp?openxpage&id="
						+ company.getId());
			} else {
	...
	public List<String> getCountrySelection() {
		return applicationController.getConfigSelection(ConfigType.COUNTRY);
	}
