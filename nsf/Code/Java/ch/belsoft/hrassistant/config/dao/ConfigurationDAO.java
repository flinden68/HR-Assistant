...
public class ConfigurationDAO implements ICrudDAO<IConfiguration, String>, Serializable {
    /**
     * 
     */
    ...
    public IConfiguration read(String id) {
        return (IConfiguration) cloudantService.findDocumentByID(IConfiguration.class, id);
    }
    
    @SuppressWarnings("unchecked")
    public List<IConfiguration> read() {
        return (List<IConfiguration>) cloudantService.findAllDocuments(IConfiguration.class);
    }
