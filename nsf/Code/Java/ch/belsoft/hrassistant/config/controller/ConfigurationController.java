...
IGuiController<IConfiguration>, Serializable {
    ...
    public String getHrConfigParamsMenuCategory(){
        return ConfigParamsMenuCategory.HR.toString();
    }
    
    public String getJobApplicantConfigParamsMenuCategory(){
        return ConfigParamsMenuCategory.JOB_APPLICANT.toString();
    }
